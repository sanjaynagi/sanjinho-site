...
**Enter Pixi 🧚 !**    
Pixi is a modern re-thinking of Conda, developed by the team at [prefix.dev](https://prefix.dev/) (some of whom developed Conda itself). At its core, Pixi uses the same underlying ecosystem of Conda packages, primarily from the conda-forge and bioconda repositories, but rethinks how environments are created, solved, and shared.
...
I’ve now been using Pixi for the past 6 months or so, and it has made life as a data scientist much more convenient. If you use Conda a lot, Pixi is well worth exploring.
